    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
                <h5 class="card-title">Tambah Data Divisi</h5>

              <!-- Floating Labels Form -->
              <form class="row g-3" action="{{ route('divisi.store') }} " method="POST" enctype="multipart/form-data">
                @csrf
                <div class="col-md-12">
                ...
                <div class="col-md-12">
                  <div class="form-floating">
                    <input type="text" class="form-control" id="floatingNama" placeholder="Nama Divisi" name="divisi" value="" required>
                    <label for="floatingNama">Nama Divisi</label>
                  </div>
                </div>
                <div class="text-end">
