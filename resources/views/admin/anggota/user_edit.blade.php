          ...
          <div class="card">
            <div class="card-body">
              ...
              <form class="row g-3" action="{{ route('user.update', $user->id) }} " method="POST">
                ...
                <div class="col-md-6">
                  <div class="form-floating">
                    <input type="text" class="form-control" id="floatingnia" placeholder="Password" value="{{ $user->nia }}"  name="nia" required>
                ...
                <div class="col-md-6">
                  <div class="form-floating">
                    <input type="text" class="form-control" id="floatingNo" placeholder="No Handphone" name="no_hp" value="{{ $user->no_hp }}">
